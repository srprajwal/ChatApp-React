    ...
    <>
      ...
      <Dialog open={newChannelModal} onOpenChange={setNewChannelModal}>
        ...
        <DialogContent className="bg-[#1c1d25] border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          <div>
            <Input placeholder="Channel Name" className="rounded-lg p-6 bg-[#2c2e3b] border-none placeholder:text-neutral-500" onChange={e => setChannelName(e.target.value)}
              value={channelName} />
          </div>
          ...
          <div>
            <MultipleSelector
              ...
              emptyIndicator={
                <p className="text-center text-lg leading-10 text-gray-600">No results found.
                </p>
              }
            />
          </div>
